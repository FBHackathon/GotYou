...
function showAlbums(data){
  ...
  htmlStr+= '<div id="album-title" name="album-title"><b>'+data[i].title+'</b></div>';
  htmlStr+= '<div id="photo-number" align="right" name="photo-number">'+data[i].number+'</div>';
  htmlStr+= '</div>';
