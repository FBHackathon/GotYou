                ...
                $JssorUtils$.$Each(formationItems, function (formationItem) {
                    ...
                    var col = formationItem[1];
                    {
                        ...
                        if (slideTransition.$FlyDirection) {
                            ...
                            //if (_StyleEnd.$Zoom || _StyleEnd.$Rotate)
                            //    $JssorUtils$.$FixBrowserBadTransform(_StyleStart, _StyleEnd);
                        }
    ...
    function JssorSlider(elmt, options) {
        ...
        function Conveyor() {
            ...
            _SelfConveyor.$OnPositionChange = function (oldPosition, newPosition) {
                ...
                _SelfSlider.$TriggerEvent(JssorSlider.$EVT_POSITION_CHANGE, GetRealIndex(oldPosition), GetRealIndex(newPosition), oldPosition, newPosition);
            };
        }
        ...
        function Carousel(slideItems) {
            ...
            $JssorAnimator$.call(_SelfCarousel, 0, 0, { $LoopLength: _Count });

            _SelfCarousel.$Count = _Count;
        ...
        function Slideshow() {
            ...
            $JssorAnimator$.call(_SelfSlideshow, -1, 2, { $Easing: $JssorEasing$.$EaseLinear, $Setter: { $Position: SetPosition} }, _Wrapper, { $Position: 1 }, { $Position: -1 });
        ...
        function CarouselPlayer(carousel, slideshow) {
            ...
            _SelfCarouselPlayer.$PlayCarousel = function (fromPosition, toPosition, duration, callback) {
                ...
                if (_Options.$HwaMode && $JssorUtils$.$IsBrowserBadTransform() && !_HandleTouchEventOnly) {
                    ...
                    $JssorUtils$.$EnableHWA(_SlideboardElmt);
                }
                else
        ...
        function SlideItem(slideElmt, slideIndex) {
            ...
            function LoadImageCompleteEventHandler(completeCallback, loadingScreen, image) {
                ...
                if (_ImageLoading) {
                    ...
                    if (imageWidth && imageHeight && _Options.$FillMode) {
                        ...
                        //0 stretch, 1 contain (keep aspect ratio and put all inside slide), 2 cover (keep aspect ratio and cover whole slide), default value is 0
                        ...
                        var fillWidth = fitHeight ? imageWidth * _SlideHeight / imageHeight : _SlideWidth;
                        var fillHeight = fitHeight ? _SlideHeight : imageHeight * _SlideWidth / imageWidth;
                        var fillY = (_SlideHeight - fillHeight) / 2;
                        var fillX = (_SlideWidth - fillWidth) / 2;
                        ...
                        $JssorUtils$.$SetStyleTop(_ImageItem, fillY);
                        $JssorUtils$.$SetStyleLeft(_ImageItem, fillX);
                    }

                    _SelfSlider.$TriggerEvent(JssorSlider.$EVT_LOAD_END, slideItem);
                }

                $JssorUtils$.$HideElement(loadingScreen || _LoadingScreen);
            ...
            function LoadSlideshowImageCompleteEventHandler(nextIndex, nextItem, slideshowTransition, loadingTicket) {
                if (loadingTicket == _LoadingTicket && _CurrentSlideIndex == slideIndex && _AutoPlay) {
                    if (!_Frozen) {
                        _SlideshowRunner.$Initialize(nextIndex, slideIndex, nextItem, _SelfSlideItem, slideshowTransition);
                        nextItem.$HideContentForSlideshow();
                        _Slideshow.$Locate(nextIndex, 1);
                        _Slideshow.$GoToPosition(nextIndex);
            ...
            function SwipeStartEventHandler() {
                if (_CurrentSlideIndex == slideIndex) {
                    _Processor && _Processor.$Stop();
                    _Processor && _Processor.$OpenSlideshowPanel();
                }
            }
            ...
            _SelfSlideItem.$LoadImage = function (completeCallback, loadingScreen) {
                if (_ImageItem) {
                    if (_ImageLoading) {
                        ...
                        var src = _ImageItem.src;
                        $JssorUtils$.$ShowElement(loadingScreen);
                        return $JssorUtils$.$LoadImage(src, $JssorUtils$.$CreateCallback(null, LoadImageCompleteEventHandler, completeCallback, loadingScreen));

                        //for debug only
                        //{
                        //    var image = new Image();
                        //    image.src = _ImageItem.src;
                        //    $JssorUtils$.$ShowElement(loadingScreen);
                        //    $JssorUtils$.$Delay($JssorUtils$.$CreateCallback(null, LoadImageCompleteEventHandler, completeCallback, loadingScreen, image), 10000);
                        //}
                    }
                }
            ...
            _SelfSlideItem.$GoForNextSlide = function () {
                if (_SlideshowRunner) {
                    ...
                    if (slideshowTransition) {
                        ...
                        var nextIndex = GetRealIndex(slideIndex + 1);
                        var nextItem = _SlideItems[nextIndex];
            ...
            function RefreshContent(elmt, fresh, level) {
                ...
                if (!_ContentRefreshed && $JssorUtils$.$IsBrowserIe9Earlier()) {
                ...
                $JssorUtils$.$Each(childElements, function (childElement, i) {
                    ...
                    if ($JssorUtils$.$GetAttribute(childElement, "u") == "caption") {
        ...
        function Processor(slideIndex, slideshowProcessor, captionSliderIn, captionSliderOut) {
            ...
            _SelfProcessor.$Replay = function () {
                ...
                if (!_IsDragging && !_IsSliding && (currentPosition != _IdleEnd || (_AutoPlay && (!_HoverToPause || _HoverStatus))) && _CurrentSlideIndex == slideIndex) {
            ...
            if (_IsDragging && (!$JssorUtils$.$IsBrowserIe9Earlier() || event.button)) {
                ...
                if (actionPoint) {
                    ...
                    if (_DragOrientation) {
                        ...
                        _PositionToGoByDrag = _DragStartPosition - _DragOffsetTotal / stepLength;

                        if (_DragOffsetTotal && _DragOrientation) {
                            $JssorUtils$.$CancelEvent(event);
                            if (!_IsSliding) {
        ...
        _SelfSlider.$SetScaleWidth = function (width) {
            ...
            if (!_SlideshowEnabled || !$JssorUtils$.$IsBrowserIE() || $JssorUtils$.$GetBrowserVersion() >= 8) {
                ...
                var scale = width / $JssorUtils$.$GetStyleWidth(_ScaleWrapper);
                $JssorUtils$.$SetStyleScale(_ScaleWrapper, scale);

                $JssorUtils$.$SetStyleWidth(elmt, width);
                $JssorUtils$.$SetStyleHeight(elmt, scale * $JssorUtils$.$GetStyleHeight(_ScaleWrapper));
            }
        };
        ...
        var _Options = $JssorUtils$.$Extend({
            $FillMode: 0,                   //[Optional] The way to fill image in slide, 0 stretch, 1 contain (keep aspect ratio and put all inside slide), 2 cover (keep aspect ratio and cover whole slide), default value is 0
        ...
        //$JssorSlider$ Constructor
        {
            ...
            //SlideBoard
            var _SlideboardElmt = CreatePanel();
            var _SlideItems = [];
            ...
            //SlideBoard Constructor
            {
                ...
                if (_Options.$PlayOrientation == 1) {
                    $JssorUtils$.$SetStyleWidth(_SlideboardElmt, _StepLengthX * _DisplayPieces - _SlideSpacing);
                }
                else {
                    $JssorUtils$.$SetStyleHeight(_SlideboardElmt, _StepLengthY * _DisplayPieces - _SlideSpacing);
                }
                ...
                //link container
                {
                    ...
                    $JssorUtils$.$AppendChild(_SlideboardElmt, _LinkContainer);
                }

                $JssorUtils$.$AppendChild(_SlidesContainer, _SlideboardElmt);

                for (var i = 0; i < _SlideElmts.length; i++) {
                    var slideElmt = _SlideElmts[i];
                    var slideItem = new SlideItem(slideElmt, i);
                    $JssorUtils$.$AppendChild(_SlideboardElmt, slideItem.$Wrapper);
...
var $JssorThumbnailNavigator$ = window.$JssorThumbnailNavigator$ = function (elmt, options) {
    ...
    function GetNearVirtualIndex(index, oldIndex) {
        var nearVirtualIndex = index;

        if (index - oldIndex > _Length / 2)
            nearVirtualIndex -= _Length;
        else if (index - oldIndex < -_Length / 2)
            nearVirtualIndex += _Length;

        return nearVirtualIndex;
    }
    ...
    function NavigationItem(item, index) {
        ...
        function OnNavigationRequest(event) {
            if (!_Slider.$LastDragSucceded()) {
                _Self.$TriggerEvent($JssorNavigatorEvents$.$NAVIGATIONREQUEST, GetNearVirtualIndex(index, _CurrentIndex));
            }
        }
    ...
    _Self.$SetCurrentIndex = function (index, virtualIndex, temp) {
        if (!temp) {
            ...
            _Slider.$PlayTo(GetNearVirtualIndex(Math.floor(virtualIndex / _Lanes), Math.floor(oldIndex / _Lanes)));
        }
    };
...
var $JssorCaptionSlider$ = window.$JssorCaptionSlider$ = function (container, captionSlideOptions, playIn) {
                ...
                if (isCaption) {
                    ...
                    if (rawTransition && rawTransition.$Transition) {
                        ...
                        if (transition) {
                            ...
                            if (!k) {
                                if ((playIn ? captionSlideOptions.$PlayInMode : captionSlideOptions.$PlayOutMode) & 2)
                                    transitionWithTuning.$BeginTime = 0;
                                else if (rawTransition.$BeginTime)
    ...
    function CreateAnimator(item, transition, immediateOut) {
        ...
        //if (toStyles.$Zoom || toStyles.$Rotate)
        //    $JssorUtils$.$FixBrowserBadTransform(fromStyles, toStyles);
...
//$EVT_POSITION_CHANGE = 202;	function(oldPosition, newPosition[, oldVirtual, newVertual])
