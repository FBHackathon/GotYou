...
SET RESERVE_MEMBERNAMES2=%RESERVE_MEMBERNAMES2%,$FillMode,$StartIndex,$PauseOnHover,$AutoPlay,$AutoPlaySteps,$AutoPlayInterval,$ArrowKeyNavigation,$SlideDuration,$SlideEasing,$MinDragOffsetToSlide,$SlideWidth,$SlideHeight,$SlideSpacing,$DisplayPieces,$ParkingPosition,$UISearchMode,$PlayOrientation,$DragOrientation,$LoadNearby,$NaviQuitDrag,$HwaMode
...
SET RESERVE_MEMBERNAMES3=$DirectionNavigatorOptions
